...
$navItems = [
    ['name' => 'Dashboard', 'icon' => 'layout', 'href' => 'index.php', 'id' => 'index.php'],
    ['name' => 'Customers', 'icon' => 'users', 'href' => 'leads.php', 'id' => 'leads.php'],
    ['name' => 'Documents', 'icon' => 'folder', 'href' => 'explorer.php', 'id' => 'explorer.php'],
];
?>
<aside id="main-sidebar" aria-label="Main Navigation" class="hidden sm:flex fixed top-0 left-0 z-40 w-64 h-screen flex-col justify-between bg-zinc-950 border-r border-zinc-800">
  <div class="px-6 py-8">
    <!-- Brand -->
    <a href="index.php" class="flex items-center gap-3 mb-10 group focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-indigo-500 rounded-md" aria-label="Go to Dashboard">
      ...
      <div>
        <h2 class="text-[16px] font-bold text-zinc-100 tracking-tight leading-none">Acme Corp</h2>
      </div>
    </a>

    <nav aria-label="Sidebar Menu" class="space-y-1">
    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center gap-3">
        ...
        <div class="flex flex-col">
          <span class="text-[14px] font-semibold text-zinc-200 leading-tight">Admin User</span>
          <span class="text-[12px] text-zinc-500 leading-tight block">admin@acme.inc</span>
        </div>
      </div>
      <a href="logout.php" aria-label="Sign out" class="p-2 text-zinc-500 hover:text-zinc-200 transition-colors rounded-md focus-visible:outline focus-visible:outline-2 focus-visible:outline-indigo-500">
